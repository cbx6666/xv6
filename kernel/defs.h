...
int             kvmmap_user(pagetable_t kpagetable, pagetable_t upagetable, uint64 va, uint64 sz);
void            kuvmdealloc(pagetable_t pagetable, uint64 oldsz, uint64 newsz, int do_free);
